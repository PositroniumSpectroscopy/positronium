...
def F_classical(n, unit='V cm^-1'):
    '''
    For each value of n the ionization field for the outermost Stark state with
    a negative Stark shift is approximately equal to the classical ionization field.
    ...
    efield = np.reciprocal(np.power(n, 4.0)) * 2.0 * constants.Ryd_Ps * constants.h * constants.c / \
                        (constants.e * constants.a_Ps * 9.0)
